...
inv_yhat = concatenate((test_X[:, 5:14], yhat), axis=1)
...
pltname = '_'.join(('savefig/' + method, operating_object, scalingmethod, testfile, str(epochs), str(batchsize), '.png'))
